...
int Adapter::call_method(const char *method, GVariant *param)
{
    ...
    result = g_dbus_connection_call_sync(s_connection,
                         "org.bluez",
                         "/org/bluez/hci0",
                         "org.bluez.Adapter1",
                         method,
...
void Adapter::signal_changed(GDBusConnection *conn,
                    const gchar *sender,
                    const gchar *path,
...
guint Adapter::subscribe_adapter_changed()
{
	return g_dbus_connection_signal_subscribe(s_connection,
                        "org.bluez",
                        "org.freedesktop.DBus.Properties",
                        "PropertiesChanged",
                        NULL,
                        ...
                        Adapter::signal_changed,
                        NULL,
                        NULL);
}

guint Adapter::subscribe_device_added(void (*f)(GDBusConnection*, 
											const gchar*, 
											const gchar*,
											const gchar*, 
											const gchar*, 
...
guint Adapter::subscribe_device_removed(void (*f)(GDBusConnection*, 
											const gchar*, 
											const gchar*,
											const gchar*, 
											const gchar*, 
